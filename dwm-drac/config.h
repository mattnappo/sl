...
static const char *spawnspectac[] = { "spectacle", NULL };
static const char *spawnpavu[]    = { "pavucontrol", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_s,      spawn,         {.v = spawnspectac } },
	{ MODKEY,                       XK_p,      spawn,         {.v = spawnpavu    } },
